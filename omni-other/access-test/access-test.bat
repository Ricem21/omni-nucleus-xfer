...
::
set CLIENT_LIB_SDK_DIR=E:\manjeet\connect-samples-205.0.0\
...
if not exist "%PYTHON%" (
    echo Python, USD, and Omniverse Client libraries are missing.  Run "repo.bat
 build --stage" to retrieve them.
    popd
    exit /b
)
